...
ActiveRecord::Schema.define(version: 20170503073619) do
  ...
  create_table "installs", force: :cascade do |t|
    t.integer "user_id"
    t.index ["id"], name: "index_installs_on_id", using: :btree
    t.index ["user_id"], name: "index_installs_on_user_id", using: :btree
  end
